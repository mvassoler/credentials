package br.com.mvassoler.credentials.core.dtos;
...
//@Schema(name = "FailureResponse", description = "Payload de representação de falha na requisição da API")
...
public class ErrorDetailsDTO implements Serializable {
    ...
    @Getter
    @Builder
    //@Schema(name = "Objeto do Problema")
